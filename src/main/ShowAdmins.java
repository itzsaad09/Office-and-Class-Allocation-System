...
public class ShowAdmins extends javax.swing.JFrame {
    ...
    private void show_Table() {
        ...
        try {
            ...
            pst = connect.prepareStatement("SELECT * FROM `signup`");
            result = pst.executeQuery();
            RSMD = result.getMetaData();
            CC = RSMD.getColumnCount();
            DTM = (DefaultTableModel)ShowAdminTable.getModel();
            
            DTM.setRowCount(0);
            while(result.next()) {
                Vector v2 = new Vector();
                for(int i=1; i<=CC; i++) {
                    v2.add(result.getString("Admin_Id"));
    ...
    private void initComponents() {
        ...
        ShowAdminsPanel = new javax.swing.JPanel();
        Header = new javax.swing.JPanel();
        Field = new javax.swing.JLabel();
        LogoutButton = new javax.swing.JButton();
        BackButton = new javax.swing.JButton();
        ShowAdminsScrollPane = new javax.swing.JScrollPane();
        ...
        ShowAdminsPanel.setBackground(new java.awt.Color(54, 79, 107));
        ...
        ShowAdminsScrollPane.setPreferredSize(new java.awt.Dimension(300, 300));

        ShowAdminTable.setBackground(new java.awt.Color(54, 79, 107));
        ShowAdminTable.setForeground(new java.awt.Color(245, 245, 245));
        ShowAdminTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Admin ID", "First Name", "Last Name", "CNIC", "Phone No", "Gender", "Status", "Email"
            }
        ) {
        ...
        ShowAdminTable.getTableHeader().setReorderingAllowed(false);
        ShowAdminsScrollPane.setViewportView(ShowAdminTable);
        if (ShowAdminTable.getColumnModel().getColumnCount() > 0) {
            ShowAdminTable.getColumnModel().getColumn(0).setMaxWidth(60);
            ShowAdminTable.getColumnModel().getColumn(1).setMaxWidth(110);
            ShowAdminTable.getColumnModel().getColumn(2).setMaxWidth(110);
            ShowAdminTable.getColumnModel().getColumn(3).setMaxWidth(140);
            ShowAdminTable.getColumnModel().getColumn(4).setMaxWidth(100);
            ShowAdminTable.getColumnModel().getColumn(5).setMaxWidth(60);
            ShowAdminTable.getColumnModel().getColumn(6).setMaxWidth(60);
            ShowAdminTable.getColumnModel().getColumn(7).setMaxWidth(250);
        }
        ...
        javax.swing.GroupLayout ShowAdminsPanelLayout = new javax.swing.GroupLayout(ShowAdminsPanel);
        ShowAdminsPanel.setLayout(ShowAdminsPanelLayout);
        ShowAdminsPanelLayout.setHorizontalGroup(
            ShowAdminsPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(ShowAdminsPanelLayout.createSequentialGroup()
                .addComponent(Header, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, Short.MAX_VALUE))
            .addComponent(Footer, javax.swing.GroupLayout.DEFAULT_SIZE, 900, Short.MAX_VALUE)
            .addGroup(ShowAdminsPanelLayout.createSequentialGroup()
                .addGap(20, 20, 20)
                .addComponent(ShowAdminsScrollPane, javax.swing.GroupLayout.PREFERRED_SIZE, 860, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ShowAdminsPanelLayout.setVerticalGroup(
            ShowAdminsPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(ShowAdminsPanelLayout.createSequentialGroup()
                .addComponent(Header, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(ShowAdminsScrollPane, javax.swing.GroupLayout.DEFAULT_SIZE, 348, Short.MAX_VALUE)
                .addGap(18, 18, 18)
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(ShowAdminsPanel, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );
    ...
    private javax.swing.JPanel ShowAdminsPanel;
    private javax.swing.JScrollPane ShowAdminsScrollPane;
