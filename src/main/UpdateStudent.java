...
public class UpdateStudent extends javax.swing.JFrame {
    ...
    public UpdateStudent(String email) {
        initComponents();
        // Set Title
        this.setTitle("Office and Class Allocation System");
        // Database Connection
    ...
    private void initComponents() {
        ...
        UpdateStudentPanel.setBackground(new java.awt.Color(54, 79, 107));
        UpdateStudentPanel.setPreferredSize(new java.awt.Dimension(900, 500));
        ...
        if(evt.getKeyCode()==KeyEvent.VK_ENTER) {
            ...
            try {
                ...
                if (result.next()) {
                    ...
                    if(result.getString(7).equals("Active")) {
                        Active.setSelected(true);
                        Inactive.setSelected(false);
                    } else if(result.getString(7).equals("In-Active")) {
                        Active.setSelected(false);
                        Inactive.setSelected(true);
                    }
                    Department.setSelectedItem(result.getString(8));
                    ProgramField.setText(result.getString(9));
    ...
    private void UpdateRecordMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_UpdateRecordMouseClicked
        ...
        String value7 = checkStatus;
        
        if (fName.equals("") || lName.equals("") || cnic.equals("00000-0000000-0") || phoneno.equals("0333-1234567") || gender.equals("Select Gender") || checkStatus.equals("checkStatus") || department.equals("Select Department") || program.equals("") || email.equals("") || password.equals("")){
            FirstName.setForeground(Color.RED);
            LastName.setForeground(Color.RED);
            CNIC.setForeground(Color.RED);
            PhoneNo.setForeground(Color.RED);
        ...
        } else if (lName.equals("") || cnic.equals("00000-0000000-0") || phoneno.equals("0333-1234567") || gender.equals("Select Gender") || checkStatus.equals("checkStatus") || department.equals("Select Department") || program.equals("") || email.equals("") || password.equals("")) {
            LastName.setForeground(Color.RED);
            CNIC.setForeground(Color.RED);
            PhoneNo.setForeground(Color.RED);
            Gender.setBackground(Color.RED);
            ...
            Email.setForeground(Color.RED);
            Password.setForeground(Color.RED);
        } else if (cnic.equals("00000-0000000-0") || phoneno.equals("0333-1234567") || gender.equals("Select Gender") || checkStatus.equals("checkStatus") || department.equals("Select Department") || program.equals("") || email.equals("") || password.equals("")) {
            CNIC.setForeground(Color.RED);
            PhoneNo.setForeground(Color.RED);
            Gender.setBackground(Color.RED);
            Status.setForeground(Color.RED);
            ...
            Email.setForeground(Color.RED);
            Password.setForeground(Color.RED);
        } else if (phoneno.equals("0333-1234567") || gender.equals("Select Gender") || checkStatus.equals("checkStatus") || department.equals("Select Department") || program.equals("") || email.equals("") || password.equals("")) {
            PhoneNo.setForeground(Color.RED);
            Gender.setBackground(Color.RED);
            Status.setForeground(Color.RED);
            Department.setBackground(Color.RED);
            Email.setForeground(Color.RED);
            Password.setForeground(Color.RED);
        } else if (gender.equals("Select Gender") || checkStatus.equals("checkStatus") || department.equals("Select Department") || program.equals("") || email.equals("") || password.equals("")) {
            Gender.setBackground(Color.RED);
            Status.setForeground(Color.RED);
            Department.setBackground(Color.RED);
            ProgramofStudy.setForeground(Color.RED);
            Email.setForeground(Color.RED);
            Password.setForeground(Color.RED);
        } else if (checkStatus.equals("checkStatus") || department.equals("Select Department") || program.equals("") || email.equals("") || password.equals("")) {
            Status.setForeground(Color.RED);
            Department.setBackground(Color.RED);
            Email.setForeground(Color.RED);
            Password.setForeground(Color.RED);
            ...
            if (temp == true) {
                String query = "UPDATE `student` SET `ID`='"+ID+"',`fName`='"+fName+"',`lName`='"+lName+"',`cnic`='"+cnic+"',`phoneno`='"+phoneno+"',`gender`='"+gender+"',`department`='"+department+"',`program`='"+program+"',`email`='"+email+"',`password`='"+password+"',`status`='"+value7+"' WHERE `ID`='"+ID+"'";
                try {
                    pst = connect.prepareStatement(query);
