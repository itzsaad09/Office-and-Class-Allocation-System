...
public class RegisterCourse extends javax.swing.JFrame {
    ...
    public RegisterCourse(String email) {
        initComponents();
        // Set Title
        this.setTitle("Office and Class Allocation System");
        // Database Connection
    ...
    private void show_Table() {
        ...
        try {
            // Database Connection
            connect = Database.getConnection();
            pst = connect.prepareStatement("SELECT `course_code`, `credit_hours`, `course` FROM `class`");
            result = pst.executeQuery();
            RSMD = result.getMetaData();
            CC = RSMD.getColumnCount();
            DTM = (DefaultTableModel)RegisterCoursesTable.getModel();
    ...
    private void initComponents() {
        ...
        RegisterCoursesScrollPane = new javax.swing.JScrollPane();
        RegisterCoursesTable = new javax.swing.JTable();
        ...
        RegisterCoursesScrollPane.setPreferredSize(new java.awt.Dimension(300, 300));

        RegisterCoursesTable.setBackground(new java.awt.Color(54, 79, 107));
        RegisterCoursesTable.setForeground(new java.awt.Color(245, 245, 245));
        RegisterCoursesTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null},
                {null, null, null},
                {null, null, null},
        ...
        RegisterCoursesTable.getTableHeader().setReorderingAllowed(false);
        RegisterCoursesScrollPane.setViewportView(RegisterCoursesTable);
        if (RegisterCoursesTable.getColumnModel().getColumnCount() > 0) {
            RegisterCoursesTable.getColumnModel().getColumn(0).setMinWidth(100);
            RegisterCoursesTable.getColumnModel().getColumn(0).setMaxWidth(200);
            RegisterCoursesTable.getColumnModel().getColumn(1).setMinWidth(100);
            RegisterCoursesTable.getColumnModel().getColumn(1).setMaxWidth(200);
        }
        ...
        Enroll.setFont(new java.awt.Font("Segoe UI Black", 0, 12)); // NOI18N
        Enroll.setForeground(new java.awt.Color(54, 79, 107));
        Enroll.setText("Enroll");
        Enroll.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        Enroll.setPreferredSize(new java.awt.Dimension(90, 30));
        ...
        RegisterCoursesPanelLayout.setHorizontalGroup(
            ...
            .addGroup(RegisterCoursesPanelLayout.createSequentialGroup()
                .addGap(20, 20, 20)
                .addComponent(RegisterCoursesScrollPane, javax.swing.GroupLayout.PREFERRED_SIZE, 460, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addGroup(RegisterCoursesPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, RegisterCoursesPanelLayout.createSequentialGroup()
                        .addComponent(EnterCourseName, javax.swing.GroupLayout.PREFERRED_SIZE, 344, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(20, 20, 20))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, RegisterCoursesPanelLayout.createSequentialGroup()
        ...
        RegisterCoursesPanelLayout.setVerticalGroup(
            ...
            .addGroup(RegisterCoursesPanelLayout.createSequentialGroup()
                ...
                .addGroup(RegisterCoursesPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(RegisterCoursesPanelLayout.createSequentialGroup()
                        .addGap(18, 18, 18)
                        .addComponent(RegisterCoursesScrollPane, javax.swing.GroupLayout.DEFAULT_SIZE, 348, Short.MAX_VALUE)
                        .addGap(18, 18, 18))
                    .addGroup(RegisterCoursesPanelLayout.createSequentialGroup()
                        .addGap(54, 54, 54)
    ...
    private void EnrollMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_EnrollMouseClicked
        // TODO add your handling code here:
        String enroll_courses = EnterCourses.getText();
        if (temp == true) {
            String query = "UPDATE `student` SET `enroll_courses`='"+enroll_courses+"' WHERE `email`='"+email+"'";
                    try {
    ...
    private javax.swing.JScrollPane RegisterCoursesScrollPane;
    private javax.swing.JTable RegisterCoursesTable;
