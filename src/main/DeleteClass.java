...
public class DeleteClass extends javax.swing.JFrame {
    ...
    public DeleteClass(String email) {
        initComponents();
        // Set Title
        this.setTitle("Office and Class Allocation System");
        // Database Connection
    ...
    private void initComponents() {
        ...
        DeleteClassForm = new javax.swing.JPanel();
        ...
        DeleteClassPanel.setBackground(new java.awt.Color(54, 79, 107));
        DeleteClassPanel.setPreferredSize(new java.awt.Dimension(900, 500));
        ...
        DeleteClassForm.setOpaque(false);
        DeleteClassForm.setPreferredSize(new java.awt.Dimension(470, 330));
        ...
        DeleteRecord.setFont(new java.awt.Font("Segoe UI Black", 0, 14)); // NOI18N
        DeleteRecord.setForeground(new java.awt.Color(54, 79, 107));
        DeleteRecord.setText("Delete Class");
        DeleteRecord.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        DeleteRecord.setPreferredSize(new java.awt.Dimension(90, 30));
        DeleteRecord.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                DeleteRecordMouseClicked(evt);
            }
        });
        DeleteRecord.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                DeleteRecordKeyPressed(evt);
            }
        });

        javax.swing.GroupLayout DeleteClassFormLayout = new javax.swing.GroupLayout(DeleteClassForm);
        DeleteClassForm.setLayout(DeleteClassFormLayout);
        DeleteClassFormLayout.setHorizontalGroup(
            DeleteClassFormLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(DeleteClassFormLayout.createSequentialGroup()
                .addGroup(DeleteClassFormLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(DeleteClassFormLayout.createSequentialGroup()
                        .addGap(36, 36, 36)
                        .addGroup(DeleteClassFormLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(Course)
                    ...
                    .addGroup(DeleteClassFormLayout.createSequentialGroup()
                        .addGap(371, 371, 371)
                        .addComponent(DeleteRecord, javax.swing.GroupLayout.PREFERRED_SIZE, 125, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(36, 36, 36))
        );
        DeleteClassFormLayout.setVerticalGroup(
            DeleteClassFormLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(DeleteClassFormLayout.createSequentialGroup()
                .addGap(55, 55, 55)
                .addGroup(DeleteClassFormLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(DeleteClassFormLayout.createSequentialGroup()
                        .addGroup(DeleteClassFormLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(DeleteClassFormLayout.createSequentialGroup()
                                .addComponent(CourseCode)
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(DeleteRecord, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(DeleteClassFormLayout.createSequentialGroup()
                        .addGroup(DeleteClassFormLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(DeleteClassFormLayout.createSequentialGroup()
                                .addComponent(AcademicYear)
                        ...
                        .addGroup(DeleteClassFormLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(DeleteClassFormLayout.createSequentialGroup()
                                ...
                                .addComponent(Seats)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(DeleteClassFormLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        DeleteClassPanelLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, DeleteClassPanelLayout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(DeleteClassForm, javax.swing.GroupLayout.PREFERRED_SIZE, 861, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(19, 19, 19))
        );
        DeleteClassPanelLayout.setVerticalGroup(
            ...
            .addGroup(DeleteClassPanelLayout.createSequentialGroup()
                .addComponent(Header, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(27, 27, 27)
                .addComponent(DeleteClassForm, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        // TODO add your handling code here:
        String query_instructor = "SELECT `fName` FROM `instructor`";
        try {
            pst = connect.prepareStatement(query_instructor);
            result = pst.executeQuery(query_instructor);
            while (result.next()) {
                String item = result.getString("fName");
    ...
    private void DeleteRecordMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_DeleteRecordMouseClicked
        ...
        String academic_year = SeatsField.getText();
        ...
        if (course_code.equals("") || credit_hours.equals("") || course.equals("") || department.equals("Select Department") || program.equals("") || instructor.equals("Select Instructor") || academic_year.equals("") || academic_session.equals("Select Academic Session") || seats.equals("")){
            ...
            if (temp == true) {
                String query = "DELETE FROM `class` WHERE `course_code`=?";
                try {
                    pst = connect.prepareStatement(query);
    ...
    private void DeleteRecordKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_DeleteRecordKeyPressed
        // TODO add your handling code here:
        if(evt.getKeyCode()==KeyEvent.VK_ENTER) {
            String course_code = CourseCodeField.getText();
            String credit_hours = CreditHoursField.getText();
    ...
    }//GEN-LAST:event_DeleteRecordKeyPressed
    ...
    private javax.swing.JPanel DeleteClassForm;
