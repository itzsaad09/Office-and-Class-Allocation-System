...
public class AddInstructor extends javax.swing.JFrame {
    ...
    public AddInstructor(String email) {
        initComponents();
        // Set Title
        this.setTitle("Office and Class Allocation System");
        // Database Connection
                    ...
                    .addGroup(AddRecordFormLayout.createSequentialGroup()
                        .addGroup(AddRecordFormLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(AddRecordFormLayout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                        .addGroup(AddRecordFormLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, AddRecordFormLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addComponent(Email)
    ...
    private void AddRecordMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_AddRecordMouseClicked
        ...
        if (fName.equals("") || lName.equals("") || cnic.equals("00000-0000000-0") || phoneno.equals("0333-1234567") || gender.equals("Select Gender") || office.equals("Select Office") || status.equals("checkStatus") || department.equals("Select Department") || email.equals("") || password.equals("")){
        ...
        } else if (lName.equals("") || cnic.equals("00000-0000000-0") || phoneno.equals("0333-1234567") || gender.equals("Select Gender") || office.equals("Select Office") || status.equals("checkStatus") || department.equals("Select Department") || email.equals("") || password.equals("")) {
            LastName.setForeground(Color.RED);
            CNIC.setForeground(Color.RED);
            PhoneNo.setForeground(Color.RED);
            Gender.setBackground(Color.RED);
            ...
            Email.setForeground(Color.RED);
            Password.setForeground(Color.RED);
        } else if (cnic.equals("00000-0000000-0") || phoneno.equals("0333-1234567") || gender.equals("Select Gender") || office.equals("Select Office") || status.equals("checkStatus") || department.equals("Select Department") || email.equals("") || password.equals("")) {
            CNIC.setForeground(Color.RED);
            PhoneNo.setForeground(Color.RED);
            Gender.setBackground(Color.RED);
            Office.setBackground(Color.RED);
            ...
            Email.setForeground(Color.RED);
            Password.setForeground(Color.RED);
        } else if (phoneno.equals("0333-1234567") || gender.equals("Select Gender") || office.equals("Select Office") || status.equals("checkStatus") || department.equals("Select Department") || email.equals("") || password.equals("")) {
            PhoneNo.setForeground(Color.RED);
            Gender.setBackground(Color.RED);
            Office.setBackground(Color.RED);
            Status.setForeground(Color.RED);
            ...
            Email.setForeground(Color.RED);
            Password.setForeground(Color.RED);
        } else if (gender.equals("Select Gender") || office.equals("Select Office") || status.equals("checkStatus") || department.equals("Select Department") || email.equals("") || password.equals("")) {
            Gender.setBackground(Color.RED);
            Office.setBackground(Color.RED);
            Status.setForeground(Color.RED);
            Department.setBackground(Color.RED);
            Email.setForeground(Color.RED);
            Password.setForeground(Color.RED);
        } else if (office.equals("Select Office") || status.equals("checkStatus") || department.equals("Select Department") || email.equals("") || password.equals("")) {
            Office.setBackground(Color.RED);
            Status.setForeground(Color.RED);
            Department.setBackground(Color.RED);
            Email.setForeground(Color.RED);
            Password.setForeground(Color.RED);
        } else if (status.equals("checkStatus") || department.equals("Select Department") || email.equals("") || password.equals("")) {
            Status.setForeground(Color.RED);
            Department.setBackground(Color.RED);
            Email.setForeground(Color.RED);
            Password.setForeground(Color.RED);
            ...
            if (temp == true) {
                String query = "INSERT INTO `instructor`(`fName`, `lName`, `cnic`, `phoneno`, `gender`, `office`, `status`, `department`, `email`, `password`) VALUES (?,?,?,?,?,?,?,?,?,?)";
                try {
                    pst = connect.prepareStatement(query);
                    ...
                    pst.setString(6, (String)Office.getSelectedItem());
                    pst.setString(7, status);
                    pst.setString(8, (String)Department.getSelectedItem());
